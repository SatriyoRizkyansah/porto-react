        ...
        <div class="container">
          <div class="flex flex-wrap">
            <div class="w-full self-center text-primary px-4 lg:w-1/2">
              ...
              <div class="font-medium text-slate-400 mb-10 leading-relaxed font-mono" id="app"></div>

              <a href="https://github.com/SatriyoRizkyansah" target="_blank">
                <button type="button" class="text-base font-semibold text-white bg-primary py-2 px-4 rounded-full hover:shadow-lg opacity-80 transition duration-300 ease-in-out font-mono">
